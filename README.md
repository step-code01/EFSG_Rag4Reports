# Code Submission Github Repository for Task rag4reports

This is a git repository template for code submissions to the shared task rag4reports in TIRA.
...
```
docker build -t registry.webis.de/code-research/tira/tira-user-ug-tiet-nlp/github-action-submission:0.0.1 -f Dockerfile .
```
...
tira-cli code-submission --path ${{ inputs.directory }} --task rag4reports --dataset rag4reports/task-a-report-evaluation-20260209-training
```
